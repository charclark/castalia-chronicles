...
export default function SettingsClient({ isSuperAdmin }: { isSuperAdmin: boolean }) {
      ...
      >
        <h3
          style={{
            ...
            marginBottom: isSuperAdmin ? "1.5rem" : "0.5rem",
        ...
        {!isSuperAdmin && (
          ...
          >
            Must be 8+ characters with at least one uppercase letter, one number, and one special character.
          </p>
        )}
